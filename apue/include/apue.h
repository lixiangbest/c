 ...
 *       Filename:  apue.h
 *
 *    Description:  Advanced Programming in the UNIX Environment
 *    				Main included header C file.
 *
 *        Version:  1.0
 *        Created:  10/18/12 07:55:22
 *       Revision:  none
 *       Compiler:  gcc
 *
...
int ptym_open(char *, int);/*{Progs3 ptyopen_linux}*/
int ptys_open(char *);/*{Progs3 ptyopen_linux}*/
#ifdef TIOCGWINSZ
pid_t pty_fork(int *, char *, int, const struct termios *, const struct winsize *);/*{Prog ptyfork}*/
#endif

/*Prog lockreg, add file lock.*/
