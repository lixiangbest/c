 ...
 *       Filename:  05_shell.c
 *
 *    Description:  call the singal handler when enter Ctrl+C(interrupt key)
 *
 *        Version:  1.0
...
#include "apue.h"
#include<sys/wait.h>
static void sig_int(int);/*our singal-catching function*/

int main(void){
	char buf[MAXLINE];/*from apue.h*/
	pid_t pid;
	int status;
	/*set the singal handler*/
